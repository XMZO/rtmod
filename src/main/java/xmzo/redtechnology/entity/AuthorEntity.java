...
package xmzo.redtechnology.entity;

import xmzo.redtechnology.procedures.AuthorEntityIsHurtProcedure;
...
public class AuthorEntity extends RtModElements.ModElement {
	public static EntityType entity = null;
	public AuthorEntity(RtModElements instance) {
		super(instance, 35);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(128).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.8f)).build("author")
						.setRegistryName("author");
		elements.entities.add(() -> entity);
		elements.items
				.add(() -> new SpawnEggItem(entity, -16751053, -10079488, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("author"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("rt:textures/author.png");
				}
			};
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				AuthorEntityIsHurtProcedure.executeProcedure($_dependencies);
			}
