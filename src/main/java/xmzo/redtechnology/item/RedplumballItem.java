...
public class RedplumballItem extends RtModElements.ModElement {
	@ObjectHolder("rt:redplumball")
	public static final Item block = null;
	public RedplumballItem(RtModElements instance) {
		super(instance, 19);
	}
